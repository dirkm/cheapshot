...
//#define DIAG_DELTA_POS(D) (DiagDelta0<<(D))&get_smaller(1ULL<<(8*(8-(D))))

#define DIAG_DELTA_NEG(D) (DiagDelta0<<(8*D))

// NEG: 1 means negative 
// NEG: 0 means positive

// #define DIAG_DELTA(NEG,D) (DiagDelta0<<((8*D)&(NEG))&(~(NEG)|get_smaller(1ULL<<(8*(8-(D))))))
